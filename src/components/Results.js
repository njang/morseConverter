  ...
  render() {
    return (
      <div className="Results">
      	<h1>Results</h1>
      	<img src={ this.state.result.data[0].images.fixed_height.url } alt={ this.state.result.data[0].id }  />
      	<img src={ this.state.result.data[1].images.fixed_height.url } alt={ this.state.result.data[1].id }  />
      </div>
    );
  }
}
